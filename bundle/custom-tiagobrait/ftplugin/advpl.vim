...
hi advColorCom		ctermfg=darkgray
hi advColorRes		ctermfg=darkblue
hi advColorRep		ctermfg=blue
hi advColorOpe		ctermfg=blue
hi advColorStr		ctermfg=darkred
"hi advplColorString		ctermfg=darkred
"hi advplColorOperator 	ctermfg=navy

hi link advplConditional	advColorRep
hi link advplRepeat			advColorRep
hi link	advplOperator		advColorOpe
hi link advplDelimiters		Delimiter
hi link	advplString			advColorStr
hi link advplInclude		Include
hi link	advplStatement		advColorRes
hi link advplFunction		advColorRes
hi link advplComment		advColorCom
